...
DateTime getDateTime()
{
    ...
    return {
        static_cast<uint16_t>(year), static_cast<uint8_t>(month), static_cast<uint8_t>(day), static_cast<uint8_t>(hour),
        static_cast<uint8_t>(datetime.min), static_cast<uint8_t>(datetime.sec)
    };
}
